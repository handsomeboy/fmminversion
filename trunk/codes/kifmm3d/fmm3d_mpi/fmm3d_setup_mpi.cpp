...
int FMM3d_MPI::setup()
{
  ...
  pC( PetscOptionsGetInt(prefix().c_str(), "-np",     &_np,     &flg) );  pA(flg==true);
  ...
  /* Build contributor data for a specific processor */
  {
	  ...
	  * for more information
	  */
	 vector<int>& ctb2GlbSrcNodeMap = _let->ctb2GlbSrcNodeMap();
	 vector<int>& ctb2GlbSrcExaMap = _let->ctb2GlbSrcExaMap();
	 /* self index set */
	 IS selfis;
	 /* Combine index set */
	 IS combis;
	 ...
	 for(int i=0; i<ctb2GlbSrcExaMap.size(); i++){
	  ...
	  */
	 pC( ISCreateBlock( PETSC_COMM_SELF, dim(), ctb2GlbSrcExaMap.size(), &(ctb2GlbSrcExaMap[0]), &combis) );
	 for(int i=0; i<ctb2GlbSrcExaMap.size(); i++){
		ctb2GlbSrcExaMap[i]/=dim();
	 }
	  ...
	  * http://www-unix.mcs.anl.gov/petsc/petsc-as/snapshots/petsc-current/docs/manualpages/IS/ISCreateBlock.html
	  */
	 pC( ISCreateBlock( PETSC_COMM_SELF, srcDOF(),ctb2GlbSrcExaMap.size(), &(ctb2GlbSrcExaMap[0]), &combis) );
	 for(int i=0; i<ctb2GlbSrcExaMap.size(); i++) {
		ctb2GlbSrcExaMap[i]/=srcDOF();
	 }
	 /* http://www-unix.mcs.anl.gov/petsc/petsc-as/snapshots/petsc-current/docs/manualpages/Vec/VecScatterCreate.html
	 ...
	 for(int i=0; i<ctb2GlbSrcNodeMap.size(); i++){
	  ...
	  * http://www-unix.mcs.anl.gov/petsc/petsc-as/snapshots/petsc-current/docs/manualpages/IS/ISCreateBlock.html
	  */
	 pC( ISCreateBlock( PETSC_COMM_SELF, datSze(UE), ctb2GlbSrcNodeMap.size(), &(ctb2GlbSrcNodeMap[0]), &combis) );
	 for(int i=0; i<ctb2GlbSrcNodeMap.size(); i++){
		ctb2GlbSrcNodeMap[i]/=datSze(UE);
	 }
	 /* http://www-unix.mcs.anl.gov/petsc/petsc-as/snapshots/petsc-current/docs/manualpages/Vec/VecScatterCreate.html
  ...
  /* Build user data for a specific processor */
  {
	 ...
	 vector<int>& usr2GlbSrcNodeMap = _let->usr2GlbSrcNodeMap();
	 vector<int>& usr2GlbSrcExaMap = _let->usr2GlbSrcExaMap();
	 /*
	  * Index Sets are used to setup the vector scatters
	  * See http://www-unix.mcs.anl.gov/petsc/petsc-as/snapshots/petsc-current/docs/manualpages/IS/index.html
	  * for more information
	 ...
	 for(int i=0; i<usr2GlbSrcExaMap.size(); i++){
	  ...
	  * http://www-unix.mcs.anl.gov/petsc/petsc-as/snapshots/petsc-current/docs/manualpages/IS/ISCreateBlock.html
	  */
	 pC( ISCreateBlock( PETSC_COMM_SELF, dim(), usr2GlbSrcExaMap.size(), &(usr2GlbSrcExaMap[0]), &combis) );
	 for(int i=0; i<usr2GlbSrcExaMap.size(); i++){
		usr2GlbSrcExaMap[i]/=dim();
	 }
	 /* http://www-unix.mcs.anl.gov/petsc/petsc-as/snapshots/petsc-current/docs/manualpages/Vec/VecScatterCreate.html
	  ...
	  * http://www-unix.mcs.anl.gov/petsc/petsc-as/snapshots/petsc-current/docs/manualpages/IS/ISCreateBlock.html
	  */
	 pC( ISCreateBlock( PETSC_COMM_SELF, srcDOF(),usr2GlbSrcExaMap.size(), &(usr2GlbSrcExaMap[0]), &combis) );
	 for(int i=0; i<usr2GlbSrcExaMap.size(); i++){
		usr2GlbSrcExaMap[i]/=srcDOF();
	 }
	 /* http://www-unix.mcs.anl.gov/petsc/petsc-as/snapshots/petsc-current/docs/manualpages/Vec/VecScatterCreate.html
	 ...
	 for(int i=0; i<usr2GlbSrcNodeMap.size(); i++){
	  ...
	  * http://www-unix.mcs.anl.gov/petsc/petsc-as/snapshots/petsc-current/docs/manualpages/IS/ISCreateBlock.html
	  */
	 pC( ISCreateBlock( PETSC_COMM_SELF, datSze(UE), usr2GlbSrcNodeMap.size(), &(usr2GlbSrcNodeMap[0]), &combis) );
	 for(int i=0; i<usr2GlbSrcNodeMap.size(); i++){
		usr2GlbSrcNodeMap[i]/=datSze(UE);
	 }
	 /* http://www-unix.mcs.anl.gov/petsc/petsc-as/snapshots/petsc-current/docs/manualpages/Vec/VecScatterCreate.html
  ...
  { /* Build evaluator data */
	 ...
	 int procLclStart, procLclEnd; _let->procLclRan(_trgPos, procLclStart, procLclEnd);
